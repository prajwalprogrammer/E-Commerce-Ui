...
export default function SignIn({ navigation }) {
  ...
  return (
    <SafeAreaView
      style={{ flex: 1,backgroundColor:'#000000', paddingTop: Platform.OS === 'android' ? 25 : 0 }}>
      <LinearGradient
        ...
        >
          ...
          <Text style={{color:'white', fontSize:25, textAlign:'center', marginTop:"10%", fontFamily:'sans-serif'}}>Welcome Back</Text>
            <Input
              marginTop={10}
              value={username===""?`AC-${username}`:username}
