...
const Checkout = ({ navigation }) => {
  ...
  return (
    <ScrollView style={{ backgroundColor: "#6a5acd" }}>
      <View style={{...styles.innercontainer,backgroundColor:'#ffffff',borderRadius:30}}>
        <Grid>
          ...
          {toggleCheckBox2 ? (
            <Row>
              <View style={{ backgroundColor: "white" }}>
                ...
                >
                  <Text>3131 South West 89 Street, okhlahoma 73159</Text>
                </View>
                ...
                >
                  <Text>
                    If you have a change in Address, Please update it from your
                    App profile from Homepage.{" "}
                  </Text>
                </View>
              </View>
            </Row>
