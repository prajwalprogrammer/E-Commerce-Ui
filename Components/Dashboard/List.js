...
const List = ({navigation,route}) => {
  ...
  <TouchableOpacity style={{padding:2,width:80,zIndex:2,position: 'absolute', 
   top: 0, right:-25,  justifyContent: 'center', alignItems: 'center'}}>
         <Icon name='heart' size={20} color="#FF0707" />
       ...
       <TouchableOpacity style={styles.tab1} onPress={()=>{}}><Text style={styles.texts1}>Quantity 1</Text></TouchableOpacity>

       <TouchableOpacity style={styles.tab2} onPress={()=>{}}><Text style={styles.texts2}>Add to Cart</Text></TouchableOpacity>
